...
function TServerMethods1(connectionInfo)
{
   ...
   * @return result - Type on server: string
   */
  this.restGetDispatcher = function(Value) {
    var returnObject = this.executor.executeMethod("restGetDispatcher", "GET", [Value], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.restGetDispatcher_URL = function(Value) {
    return this.executor.getMethodURL("restGetDispatcher", "GET", [Value], arguments[1])[0];
  };
}
