...
// PASTLWTR : 1.2
// File generated on 2/9/2026 2:11:58 PM from Type Library described below.
...
//   Error creating palette bitmap of (TOAuthCodeChallenge) : Server C:\Program Files\EASendMail\Lib\native\x86\EASendMailObj.dll contains no icons
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
const
  ...
  IID_IOAuthCodeChallenge: TGUID = '{17D28951-0FB7-44C2-AE35-9C5D3E75F397}';
  CLASS_OAuthCodeChallenge: TGUID = '{D7DEAD33-FB19-407E-A80A-A5628F179CBF}';
type
...
// *********************************************************************//
  ...
  IOAuthCodeChallenge = interface;
  IOAuthCodeChallengeDisp = dispinterface;
...
// *********************************************************************//
  ...
  OAuthCodeChallenge = IOAuthCodeChallenge;
...
// *********************************************************************//
  IMail = interface(IDispatch)
    ...
    procedure Set_MultipartReportType(const pVal: WideString); safecall;
    function Get_MultipartReportType: WideString; safecall;
    ...
    property MultipartReportType: WideString read Get_MultipartReportType write Set_MultipartReportType;
  end;
...
// *********************************************************************//
  IMailDisp = dispinterface
    ...
    property MultipartReportType: WideString dispid 129;
  end;
...
// *********************************************************************//
  IBrowserUi = interface(IDispatch)
    ...
    procedure CloseBrowserByTitleEx(const Title: WideString; TimeoutMs: Integer); safecall;
  end;
...
// *********************************************************************//
  IBrowserUiDisp = dispinterface
    ...
    procedure CloseBrowserByTitleEx(const Title: WideString; TimeoutMs: Integer); dispid 9;
  end;
...
// *********************************************************************//
  IOAuthResponseParser = interface(IDispatch)
    ...
    procedure Set_AccessTokenTimestamp(pVal: TDateTime); safecall;
    ...
    property AccessTokenTimestamp: TDateTime read Get_AccessTokenTimestamp write Set_AccessTokenTimestamp;
...
// *********************************************************************//
  IOAuthResponseParserDisp = dispinterface
    ...
    property AccessTokenTimestamp: TDateTime dispid 7;
    property Scope: WideString dispid 8;
...
// *********************************************************************//
// Interface: IOAuthCodeChallenge
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {17D28951-0FB7-44C2-AE35-9C5D3E75F397}
// *********************************************************************//
  IOAuthCodeChallenge = interface(IDispatch)
    ['{17D28951-0FB7-44C2-AE35-9C5D3E75F397}']
    procedure Reset; safecall;
    function Get_Challenge: WideString; safecall;
    function Get_Verifier: WideString; safecall;
    function Get_ChallengeMethod: WideString; safecall;
    property Challenge: WideString read Get_Challenge;
    property Verifier: WideString read Get_Verifier;
    property ChallengeMethod: WideString read Get_ChallengeMethod;
  end;

// *********************************************************************//
// DispIntf:  IOAuthCodeChallengeDisp
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {17D28951-0FB7-44C2-AE35-9C5D3E75F397}
// *********************************************************************//
  IOAuthCodeChallengeDisp = dispinterface
    ...
    property Challenge: WideString readonly dispid 2;
    property Verifier: WideString readonly dispid 3;
    property ChallengeMethod: WideString readonly dispid 4;
  end;
...
{$ENDIF}
  ...
  protected
    ...
    procedure Set_MultipartReportType(const pVal: WideString);
    function Get_MultipartReportType: WideString;
  public
...
{$ENDIF}
  ...
  protected
    ...
    procedure Set_AccessTokenTimestamp(pVal: TDateTime);
    function Get_Scope: WideString;
    procedure Set_Scope(const pVal: WideString);
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
...
{$ENDIF}
  ...
  public
    ...
    procedure CloseBrowserByTitleEx(const Title: WideString; TimeoutMs: Integer);
...
// *********************************************************************//
// The Class CoOAuthCodeChallenge provides a Create and CreateRemote method to          
// create instances of the default interface IOAuthCodeChallenge exposed by              
// the CoClass OAuthCodeChallenge. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoOAuthCodeChallenge = class
    class function Create: IOAuthCodeChallenge;
    class function CreateRemote(const MachineName: string): IOAuthCodeChallenge;
  end;


// *********************************************************************//
// OLE Server Proxy class declaration
// Server Object    : TOAuthCodeChallenge
// Help String      : OAuthCodeChallenge Class
// Default Interface: IOAuthCodeChallenge
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (2) CanCreate
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TOAuthCodeChallengeProperties= class;
{$ENDIF}
  TOAuthCodeChallenge = class(TOleServer)
  private
    FIntf:        IOAuthCodeChallenge;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TOAuthCodeChallengeProperties;
    function      GetServerProperties: TOAuthCodeChallengeProperties;
{$ENDIF}
    function      GetDefaultInterface: IOAuthCodeChallenge;
  protected
    procedure InitServerData; override;
    function Get_Challenge: WideString;
    function Get_Verifier: WideString;
    function Get_ChallengeMethod: WideString;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IOAuthCodeChallenge);
    procedure Disconnect; override;
    procedure Reset;
    property DefaultInterface: IOAuthCodeChallenge read GetDefaultInterface;
    property Challenge: WideString read Get_Challenge;
    property Verifier: WideString read Get_Verifier;
    property ChallengeMethod: WideString read Get_ChallengeMethod;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TOAuthCodeChallengeProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TOAuthCodeChallengeProperties = class(TPersistent)
  private
    FServer:    TOAuthCodeChallenge;
    function    GetDefaultInterface: IOAuthCodeChallenge;
    constructor Create(AServer: TOAuthCodeChallenge);
  protected
    function Get_Challenge: WideString;
    function Get_Verifier: WideString;
    function Get_ChallengeMethod: WideString;
...
procedure TMail.Set_MultipartReportType(const pVal: WideString);
  { Warning: The property MultipartReportType has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.MultipartReportType := pVal;
end;

function TMail.Get_MultipartReportType: WideString;
begin
    Result := DefaultInterface.MultipartReportType;
end;
...
procedure TMailProperties.Set_MultipartReportType(const pVal: WideString);
  { Warning: The property MultipartReportType has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TMailProperties.Get_MultipartReportType: WideString;
begin
    Result := DefaultInterface.MultipartReportType;
end;
...
procedure TOAuthResponseParser.Set_AccessTokenTimestamp(pVal: TDateTime);
begin
  DefaultInterface.Set_AccessTokenTimestamp(pVal);
end;

function TOAuthResponseParser.Get_Scope: WideString;
begin
    Result := DefaultInterface.Scope;
end;

procedure TOAuthResponseParser.Set_Scope(const pVal: WideString);
  { Warning: The property Scope has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
...
procedure TOAuthResponseParserProperties.Set_AccessTokenTimestamp(pVal: TDateTime);
begin
  DefaultInterface.Set_AccessTokenTimestamp(pVal);
end;

function TOAuthResponseParserProperties.Get_Scope: WideString;
begin
    Result := DefaultInterface.Scope;
end;

procedure TOAuthResponseParserProperties.Set_Scope(const pVal: WideString);
  { Warning: The property Scope has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
procedure TBrowserUi.CloseBrowserByTitleEx(const Title: WideString; TimeoutMs: Integer);
begin
  DefaultInterface.CloseBrowserByTitleEx(Title, TimeoutMs);
end;
...
class function CoOAuthCodeChallenge.Create: IOAuthCodeChallenge;
begin
  Result := CreateComObject(CLASS_OAuthCodeChallenge) as IOAuthCodeChallenge;
end;

class function CoOAuthCodeChallenge.CreateRemote(const MachineName: string): IOAuthCodeChallenge;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_OAuthCodeChallenge) as IOAuthCodeChallenge;
end;

procedure TOAuthCodeChallenge.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{D7DEAD33-FB19-407E-A80A-A5628F179CBF}';
    IntfIID:   '{17D28951-0FB7-44C2-AE35-9C5D3E75F397}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TOAuthCodeChallenge.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as IOAuthCodeChallenge;
  end;
end;

procedure TOAuthCodeChallenge.ConnectTo(svrIntf: IOAuthCodeChallenge);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TOAuthCodeChallenge.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TOAuthCodeChallenge.GetDefaultInterface: IOAuthCodeChallenge;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
constructor TOAuthCodeChallenge.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TOAuthCodeChallengeProperties.Create(Self);
{$ENDIF}
end;

destructor TOAuthCodeChallenge.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TOAuthCodeChallenge.GetServerProperties: TOAuthCodeChallengeProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TOAuthCodeChallenge.Get_Challenge: WideString;
begin
    Result := DefaultInterface.Challenge;
end;

function TOAuthCodeChallenge.Get_Verifier: WideString;
begin
    Result := DefaultInterface.Verifier;
end;

function TOAuthCodeChallenge.Get_ChallengeMethod: WideString;
begin
    Result := DefaultInterface.ChallengeMethod;
end;

procedure TOAuthCodeChallenge.Reset;
begin
  DefaultInterface.Reset;
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TOAuthCodeChallengeProperties.Create(AServer: TOAuthCodeChallenge);
begin
  inherited Create;
  FServer := AServer;
end;

function TOAuthCodeChallengeProperties.GetDefaultInterface: IOAuthCodeChallenge;
begin
  Result := FServer.DefaultInterface;
end;

function TOAuthCodeChallengeProperties.Get_Challenge: WideString;
begin
    Result := DefaultInterface.Challenge;
end;

function TOAuthCodeChallengeProperties.Get_Verifier: WideString;
begin
    Result := DefaultInterface.Verifier;
end;

function TOAuthCodeChallengeProperties.Get_ChallengeMethod: WideString;
begin
    Result := DefaultInterface.ChallengeMethod;
end;
...
begin
  RegisterComponents(dtlServerPage, [TMail, TFastSender, TCertificate, TCertificateCollection, 
    ...
    TDkimConfig, TOAuthCodeChallenge]);
end;
