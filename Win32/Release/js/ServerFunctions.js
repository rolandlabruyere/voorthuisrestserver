...
function TServerMethods1(connectionInfo)
{
  ...
  /*
   * @param functionPassThru [in] - Type on server: string
   * @return result - Type on server: string
   */
  this.RestDispatcher = function(functionPassThru) {
    var returnObject = this.executor.executeMethod('RestDispatcher', "GET", [functionPassThru], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.functionPassThru = functionPassThru;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.RestDispatcher_URL = function(functionPassThru) {
    return this.executor.getMethodURL("RestDispatcher", "GET", [functionPassThru], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["RestDispatcher"]
};
