...
function TServerMethods1(connectionInfo)
{
  ...
  /*
   * @param argumentList [in] - Type on server: string
   * @return result - Type on server: string
   */
  this.restGetDispatcher = function(argumentList) {
    var returnObject = this.executor.executeMethod('restGetDispatcher', "GET", [argumentList], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.argumentList = argumentList;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.restGetDispatcher_URL = function(argumentList) {
    return this.executor.getMethodURL("restGetDispatcher", "GET", [argumentList], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["restGetDispatcher"]
};
